...
.PARAMETER Clean
Removes the image corewebapi and kills all containers based on that image.
...
Build a Docker image named corewebapi
#>
...
$imageName="corewebapi"
$projectName="corewebapi"
