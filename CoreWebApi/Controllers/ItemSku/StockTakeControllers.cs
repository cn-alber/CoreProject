    ...
    public class StockTakeControllers : ControllBase
    {
        ...
        public ResponseResult InsertTakeMain([FromBodyAttribute]JObject obj)
        {
            ...
            else
            {
                ...
                res = StockTakeHaddle.InsertStockTakeMain(WhID, Parent_WhID, CoID, UserName);
            }
            return CoreResult.NewResponse(res.s, res.d, "General");
        }
        #endregion
        ...
        public ResponseResult InsertTakeItem([FromBodyAttribute]JObject obj)
        {
            ...
            else
            {
                string CoID = GetCoid();
                string UserName = GetUname();
                res = StockTakeHaddle.InsertStockTakeItem(ParentID, SkuIDLst, CoID, UserName);
            }
            return CoreResult.NewResponse(res.s, res.d, "General");
        }
        #endregion
        ...
        public ResponseResult UnCheckTake([FromBodyAttribute]JObject obj)
        {
            ...
            else
            {
                string CoID = GetCoid();
                string UserName = GetUname();
                res = StockTakeHaddle.UnCheckStockTake(ID, CoID, UserName);
            }
            return CoreResult.NewResponse(res.s, res.d, "General");
        }
        #endregion
