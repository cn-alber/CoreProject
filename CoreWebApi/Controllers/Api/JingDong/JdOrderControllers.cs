...
namespace CoreWebApi.Api.JingDong{    
    public class JdOrderControllers : ControllBase
    {
        ...
        #region
        [HttpGetAttribute("/core/Api/JdOrder/WayBillCodeget")]
        ...
        #region 是否可以京配
        [HttpGetAttribute("/core/Api/JdOrder/RangeCheck")]
        ...
        [HttpPostAttribute("/core/Api/JdOrder/")]
        public ResponseResult jdWaybillSend([FromBodyAttribute]JObject obj){
            var m = new DataResult(1,null);
        ...
        #region
        [HttpGetAttribute("/core/Api/JdOrder/OrderPrint")]
        ...
        #region 查询京东快递物流跟踪信息 
        [HttpGetAttribute("/core/Api/JdOrder/TraceGet")]
        ...
        #region 修改京东快递包裹数
        [HttpGetAttribute("/core/Api/JdOrder/PackageUpdate")]
        ...
        #region
        [HttpGetAttribute("/core/Api/JdOrder/OrderIntercept")]
